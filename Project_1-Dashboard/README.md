...
### Dashboard File
My final dashboard is in [1_Salary_Dashboard.xlsx](Project_Salary_Dashboard.xlsx).
...
In this salary dashboard I was able to gather insights into data-related job titles allowing me to make informed decsisions for my career path. I did this by analyzing how location and job type can infuence salaries. 
